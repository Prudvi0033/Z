      ...
      <div className="container mx-auto px-2">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="bg-neutral-900/30 rounded-md shadow-[inset_0.0005px_0.005px_2px_#525252] p-6 border border-neutral-900 animate-pulse"
            >
              <div className="flex flex-col items-center">
                <div className="w-20 h-20 rounded-full mb-6 bg-neutral-800" />
                <div className="h-4 w-24 bg-neutral-800 rounded mb-2" />
                <div className="h-3 w-20 bg-neutral-800 rounded mb-6" />
                <div className="w-full h-10 bg-neutral-800 rounded-4xl" />
              </div>
            </div>
          ))}
        </div>
